...
const API_BASE = '/api/ebay-inventory-smart-rebalancer/';

const TABS: { label: string; section: string; action: string }[] = [
  { label: 'ダッシュボード', section: 'dashboard', action: 'summary' },
  { label: '在庫', section: 'inventory', action: 'list' },
  { label: '移動', section: 'transfers', action: 'list' },
...
export default function Page() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold text-rose-600">在庫スマートリバランサー</h1>
