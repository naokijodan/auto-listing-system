...
const TABS = [
  ...
  { key: "orders", label: "注文", path: "orders/summary" },
  { key: "currencies", label: "通貨", path: "currencies/summary" },
  { key: "conversions", label: "変換", path: "conversions/summary" },
  { key: "analytics", label: "分析", path: "analytics/overview" },
  { key: "settings", label: "設定", path: "settings/get" },
] as const;

const API_BASE = "/api/ebay-order-multi-currency-processor/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-yellow-600">注文マルチ通貨プロセッサー</h1>
