...
const API_BASE = '/api/ebay-product-description-generator-pro/';

const tabs = [
  { key: 'dashboard', label: 'ダッシュボード' },
  { key: 'descriptions', label: '説明文' },
...
export default function ProductDescriptionGeneratorProPage(): React.ReactElement {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-violet-600">商品説明生成Pro</h1>
          ...
          <button
            ...
            className={
              ...
              (active === t.key
                ...
                : 'border-transparent text-gray-600 hover:text-violet-600 hover:border-violet-600')
            }
