...
const TABS = [
  ...
  { key: 'splits', label: '分割', path: 'splits' },
...
const API_BASE = '/api/ebay-order-split-shipper/'

export default function OrderSplitShipperPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-blue-600">注文分割配送</h1>
