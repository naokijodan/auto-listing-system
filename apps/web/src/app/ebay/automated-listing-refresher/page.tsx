...
const TABS = [
  ...
  { key: 'refreshes', label: 'リフレッシュ', path: 'refreshes' },
...
const API_BASE = '/api/ebay-automated-listing-refresher/'

export default function AutomatedListingRefresherPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-red-600">自動出品リフレッシャー</h1>
