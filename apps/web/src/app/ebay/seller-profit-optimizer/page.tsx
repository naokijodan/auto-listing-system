...
type TabKey = "dashboard" | "sellers" | "profits" | "strategies" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-profit-optimizer/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-blue-600">セラープロフィットオプティマイザー</h1>
        <p className="text-sm text-gray-500">Seller Profit Optimizer</p>
      </header>
