...
type TabKey = "dashboard" | "scores" | "criteria" | "improvements" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-quality-scorer-pro";
...
export default function ListingQualityScorerProPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-teal-600">出品品質スコアラーPro</h1>
        <p className="text-sm text-gray-500">Listing Quality Scorer Pro</p>
      </header>
