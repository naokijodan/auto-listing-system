...
const apiBase = '/api/ebay-seller-revenue-optimizer/';
...
export default function SellerRevenueOptimizerPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-sky-600">セラー売上最適化</h1>
