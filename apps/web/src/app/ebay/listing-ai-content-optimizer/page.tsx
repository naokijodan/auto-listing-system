...
const TABS = [
  ...
  { key: "optimization", label: "最適化", path: "optimization/overview" },
...
const API_BASE = "/api/ebay-listing-ai-content-optimizer/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-emerald-600">出品AIコンテンツオプティマイザー</h1>
