...
type TabKey = "dashboard" | "calculations" | "scenarios" | "reports" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-profit-calculator-pro/";
...
export default function SellerProfitCalculatorProPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-fuchsia-600">セラー利益計算機Pro</h1>
        <p className="text-sm text-gray-500">Seller Profit Calculator Pro</p>
      </header>
