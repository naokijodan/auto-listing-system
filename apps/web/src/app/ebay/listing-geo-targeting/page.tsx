...
type TabKey = 'dashboard' | 'listings' | 'regions' | 'campaigns' | 'analytics' | 'settings';
...
const API_BASE = '/api/ebay-listing-geo-targeting/';
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-semibold text-red-600">出品ジオターゲティング</h1>
