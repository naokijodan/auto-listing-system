...
const BASE_API = '/api/ebay-listing-compliance-checker/';

export default function ListingComplianceCheckerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-slate-600">出品コンプライアンスチェッカー</h1>
