...
type TabKey = "dashboard" | "fees" | "optimization" | "categories" | "analytics" | "settings";
...
const BASE = "/api/ebay-marketplace-fee-optimizer";
...
export default function MarketplaceFeeOptimizerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-rose-600">マーケットプレイス手数料最適化</h1>
        <p className="text-sm text-gray-500">カテゴリ別手数料の最適化と節約提案</p>
      </header>
