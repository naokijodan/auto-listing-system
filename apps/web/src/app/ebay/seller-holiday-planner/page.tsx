...
type TabKey = "dashboard" | "holidays" | "schedules" | "promotions" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-holiday-planner";
...
export default function SellerHolidayPlannerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-yellow-600">セラーホリデープランナー</h1>
        <p className="text-sm text-gray-500">Seller Holiday Planner</p>
      </header>
