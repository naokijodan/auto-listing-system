...
type TabKey = "dashboard" | "drafts" | "templates" | "validation" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-draft-manager";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  drafts: `${BASE}/drafts`,
  templates: `${BASE}/templates`,
  validation: `${BASE}/issues`,
  analytics: `${BASE}/analytics`,
  settings: `${BASE}/settings`,
};

export default function ListingDraftManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-cyan-600">出品下書き管理</h1>
        <p className="text-sm text-gray-500">Listing Draft Manager</p>
      </header>
