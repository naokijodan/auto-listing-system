...
const API_BASE = '/api/ebay-order-delivery-estimator';
...
export default function OrderDeliveryEstimatorPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-blue-600">注文配送見積ツール</h1>
        ...
        {TABS.map((t) => (
          <button
            ...
            className={`px-3 py-2 text-sm rounded-t-md border-b-2 ${
              tab === t.key ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600 hover:text-gray-800'
            }`}
          >
            {t.label}
          </button>
