...
type TabKey = "dashboard" | "batches" | "orders" | "rules" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-batch-processor";
...
export default function OrderBatchProcessorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-sky-600">注文バッチプロセッサー</h1>
        <p className="text-sm text-gray-500">注文のバッチ処理を管理</p>
      </header>
