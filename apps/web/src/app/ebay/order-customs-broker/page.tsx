...
type TabKey = "dashboard" | "orders" | "customs" | "declarations" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-customs-broker/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-sky-600">注文カスタムスブローカー</h1>
        <p className="text-sm text-gray-500">Order Customs Broker</p>
      </header>
