...
const BASE_API = '/api/ebay-seller-social-media-hub/';

export default function SellerSocialMediaHubPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-green-600">セラーソーシャルメディアハブ</h1>
