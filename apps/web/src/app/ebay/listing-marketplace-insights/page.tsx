...
const tabs = [
  ...
  { key: 'markets', label: 'マーケット', endpoint: 'markets' },
  { key: 'competitors', label: '競合', endpoint: 'competitors' },
  { key: 'analytics', label: '分析', endpoint: 'analytics' },
  { key: 'settings', label: '設定', endpoint: 'settings' },
] as const;

const apiBase = '/api/ebay-listing-marketplace-insights/';

export default function ListingMarketplaceInsightsPage(): React.ReactElement {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-pink-600">出品マーケットプレイスインサイト</h1>
