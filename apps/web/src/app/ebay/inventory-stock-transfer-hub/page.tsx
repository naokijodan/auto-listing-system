...
type TabKey = "dashboard" | "inventory" | "transfers" | "locations" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-stock-transfer-hub/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-green-600">在庫ストックトランスファーハブ</h1>
        <p className="text-sm text-gray-500">Inventory Stock Transfer Hub</p>
      </header>
