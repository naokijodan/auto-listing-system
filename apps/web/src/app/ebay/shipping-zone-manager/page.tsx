...
type TabKey = "dashboard" | "zones" | "countries" | "rates" | "analytics" | "settings";
...
const BASE = "/api/ebay-shipping-zone-manager";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  zones: `${BASE}/zones/list`,
  countries: `${BASE}/countries/list`,
  rates: `${BASE}/rates/list`,
  analytics: `${BASE}/analytics`,
  settings: `${BASE}/settings`,
};

export default function ShippingZoneManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-green-600">配送ゾーン管理</h1>
        <p className="text-sm text-gray-500">Shipping Zone Manager</p>
      </header>
