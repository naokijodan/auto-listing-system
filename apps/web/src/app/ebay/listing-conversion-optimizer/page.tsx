...
type TabKey = "dashboard" | "listings" | "tests" | "recommendations" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-conversion-optimizer";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  listings: `${BASE}/listings/list`,
  tests: `${BASE}/tests/list`,
  recommendations: `${BASE}/recommendations/list`,
  analytics: `${BASE}/analytics`,
  settings: `${BASE}/settings`,
};

export default function ListingConversionOptimizerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-sky-600">出品コンバージョン最適化</h1>
        <p className="text-sm text-gray-500">Listing Conversion Optimizer</p>
      </header>
