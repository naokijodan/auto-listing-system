...
type TabKey = "dashboard" | "updates" | "templates" | "rules" | "analytics" | "settings";
...
const BASE = "/api/ebay-bulk-description-updater";
...
export default function BulkDescriptionUpdaterPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-sky-600">一括説明文更新</h1>
        <p className="text-sm text-gray-500">Bulk Description Updater</p>
      </header>
