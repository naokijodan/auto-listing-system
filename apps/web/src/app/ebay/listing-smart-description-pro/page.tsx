...
type TabKey = "dashboard" | "listings" | "descriptions" | "templates" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-smart-description-pro/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-red-600">出品スマートディスクリプションPro</h1>
        <p className="text-sm text-gray-500">Listing Smart Description Pro</p>
      </header>
