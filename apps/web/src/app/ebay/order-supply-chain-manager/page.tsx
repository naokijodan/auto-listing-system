...
const API_BASE = '/api/ebay-order-supply-chain-manager/';

const TABS: { label: string; section: string; action: string }[] = [
  { label: 'ダッシュボード', section: 'dashboard', action: 'summary' },
  { label: '注文', section: 'orders', action: 'list' },
  { label: 'サプライヤー', section: 'suppliers', action: 'list' },
  { label: 'ロジスティクス', section: 'logistics', action: 'list' },
...
export default function Page() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold text-violet-600">注文サプライチェーン管理</h1>
