...
const API_BASE = "/api/ebay-listing-translation-hub/";

const tabs = [
  { key: "dashboard", label: "ダッシュボード", path: "dashboard" },
  { key: "translations", label: "翻訳", path: "translations" },
  { key: "languages", label: "言語", path: "languages" },
  { key: "quality", label: "品質", path: "quality" },
  { key: "analytics", label: "分析", path: "analytics" },
  { key: "settings", label: "設定", path: "settings" },
];

export default function ListingTranslationHubPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-rose-600">出品翻訳ハブ</h1>
        ...
        {tabs.map((t) => (
          <button
            ...
            className={`px-3 py-2 text-sm border-b-2 -mb-px ${
              active === t.key ? "border-rose-600 text-rose-600" : "border-transparent text-gray-600 hover:text-gray-900"
            }`}
          >
            {t.label}
          </button>
