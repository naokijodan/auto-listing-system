...
type TabKey = "dashboard" | "consolidations" | "orders" | "rules" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-consolidation-tool";
...
export default function OrderConsolidationToolPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-purple-600">注文統合ツール</h1>
        <p className="text-sm text-gray-500">Order Consolidation Tool</p>
      </header>
