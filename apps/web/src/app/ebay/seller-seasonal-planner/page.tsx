...
const TABS = [
  ...
  { key: "seasons", label: "シーズン", path: "seasons/summary" },
  { key: "campaigns", label: "キャンペーン", path: "campaigns/summary" },
  { key: "forecasts", label: "予測", path: "forecasts/summary" },
  { key: "analytics", label: "分析", path: "analytics/overview" },
  { key: "settings", label: "設定", path: "settings/get" },
] as const;

const API_BASE = "/api/ebay-seller-seasonal-planner/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-cyan-600">セラーシーズナルプランナー</h1>
