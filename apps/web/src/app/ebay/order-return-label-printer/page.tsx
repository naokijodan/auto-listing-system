...
type TabKey = "dashboard" | "labels" | "printers" | "orders" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-return-label-printer/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-indigo-600">注文返品ラベルプリンター</h1>
        <p className="text-sm text-gray-500">Order Return Label Printer</p>
      </header>
