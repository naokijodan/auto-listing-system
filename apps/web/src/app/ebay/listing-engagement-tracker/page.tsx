...
type TabKey = "dashboard" | "engagements" | "metrics" | "recommendations" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-engagement-tracker";
...
export default function ListingEngagementTrackerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-lime-600">出品エンゲージメントトラッカー</h1>
        <p className="text-sm text-gray-500">Listing Engagement Tracker</p>
      </header>
