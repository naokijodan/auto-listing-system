...
const TABS = [
  ...
  { key: 'content', label: 'コンテンツ', path: 'content' },
  { key: 'templates', label: 'テンプレート', path: 'templates' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-listing-dynamic-content/'

export default function ListingDynamicContentPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-green-600">出品ダイナミックコンテンツ</h1>
