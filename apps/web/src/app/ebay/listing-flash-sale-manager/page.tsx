...
type TabKey = "dashboard" | "listings" | "sales" | "schedules" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-flash-sale-manager/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-emerald-600">出品フラッシュセールマネージャー</h1>
        <p className="text-sm text-gray-500">Listing Flash Sale Manager</p>
      </header>
