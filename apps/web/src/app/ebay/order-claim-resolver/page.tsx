...
type TabKey = "dashboard" | "orders" | "claims" | "resolutions" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-claim-resolver/";
...
export default function OrderClaimResolverPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-lime-600">注文クレーム解決エンジン</h1>
        <p className="text-sm text-gray-500">Order Claim Resolver</p>
      </header>
