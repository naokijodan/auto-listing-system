...
type TabKey = "dashboard" | "tests" | "variants" | "listings" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-ab-testing-suite/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-teal-600">出品ABテスティングスイート</h1>
        <p className="text-sm text-gray-500">Listing AB Testing Suite</p>
      </header>
