...
type TabKey = "dashboard" | "tests" | "variants" | "results" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-ab-test-manager";
...
export default function ListingAbTestManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-red-600">出品A/Bテストマネージャー</h1>
        <p className="text-sm text-gray-500">A/Bテストの作成、管理、分析</p>
      </header>
