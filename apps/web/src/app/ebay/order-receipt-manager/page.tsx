...
const API_BASE = '/api/ebay-order-receipt-manager/';

const TABS = [
  { key: 'dashboard', label: 'ダッシュボード', endpoint: 'dashboard/summary' },
  { key: 'receipts', label: 'レシート', endpoint: 'receipts' },
  { key: 'templates', label: 'テンプレート', endpoint: 'templates' },
  { key: 'exports', label: 'エクスポート', endpoint: 'exports' },
...
export default function Page(): JSX.Element {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold text-emerald-600">注文レシート管理</h1>
