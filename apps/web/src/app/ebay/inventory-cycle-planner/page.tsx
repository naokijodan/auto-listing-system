...
type TabKey = "dashboard" | "cycles" | "schedules" | "inventory" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-cycle-planner/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-orange-600">在庫サイクルプランナー</h1>
        <p className="text-sm text-gray-500">Inventory Cycle Planner</p>
      </header>
