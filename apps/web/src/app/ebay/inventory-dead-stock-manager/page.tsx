...
const API_BASE = '/api/ebay-inventory-dead-stock-manager/'

export default function InventoryDeadStockManagerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-fuchsia-600">在庫デッドストック管理</h1>
