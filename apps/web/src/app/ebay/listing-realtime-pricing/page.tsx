...
const BASE_API = '/api/ebay-listing-realtime-pricing/';

export default function ListingRealtimePricingPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-teal-600">出品リアルタイムプライシング</h1>
