...
const tabs = [
  ...
  { key: 'queue', label: 'キュー', endpoint: 'queue/list' },
  { key: 'analytics', label: '分析', endpoint: 'analytics' },
  { key: 'settings', label: '設定', endpoint: 'settings' },
] as const;

const apiBase = '/api/ebay-order-priority-manager/';

export default function OrderPriorityManagerPage(): React.ReactElement {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-red-600">注文優先度管理</h1>
