...
const TABS = [
  ...
  { key: 'imports', label: 'インポート', path: 'imports' },
  { key: 'mappings', label: 'マッピング', path: 'mappings' },
  { key: 'sources', label: 'ソース', path: 'sources' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-product-import-wizard/'

export default function ProductImportWizardPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-blue-600">商品インポートウィザード</h1>
