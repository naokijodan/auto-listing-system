...
type TabKey = "dashboard" | "orders" | "labels" | "batches" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-bulk-label-generator/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-fuchsia-600">注文一括ラベルジェネレーター</h1>
        <p className="text-sm text-gray-500">Order Bulk Label Generator</p>
      </header>
