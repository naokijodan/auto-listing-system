...
type TabKey = "dashboard" | "sellers" | "revenues" | "forecasts" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-revenue-forecaster/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-indigo-600">セラー収益フォーキャスター</h1>
        <p className="text-sm text-gray-500">Seller Revenue Forecaster</p>
      </header>
