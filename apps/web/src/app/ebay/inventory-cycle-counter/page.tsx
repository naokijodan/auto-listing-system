...
const TABS = [
  ...
  { key: 'counts', label: 'カウント', path: 'counts' },
  { key: 'schedules', label: 'スケジュール', path: 'schedules' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-inventory-cycle-counter/'

export default function InventoryCycleCounterPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-yellow-600">在庫サイクルカウンター</h1>
