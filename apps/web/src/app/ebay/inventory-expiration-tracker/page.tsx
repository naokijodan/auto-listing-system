...
const API_BASE = '/api/ebay-inventory-expiration-tracker/';
...
export default function InventoryExpirationTrackerPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-red-600">在庫有効期限トラッカー</h1>
