...
const TABS = [
  ...
  { key: 'deliveries', label: '配送', path: 'deliveries' },
  { key: 'carriers', label: 'キャリア', path: 'carriers' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-order-delivery-tracker-pro/'

export default function OrderDeliveryTrackerProPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-green-600">注文デリバリートラッカーPro</h1>
