...
type TabKey = "dashboard" | "impressions" | "listings" | "keywords" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-impression-tracker";
...
export default function ListingImpressionTrackerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-red-600">出品インプレッショントラッカー</h1>
        <p className="text-sm text-gray-500">Listing Impression Tracker</p>
      </header>
