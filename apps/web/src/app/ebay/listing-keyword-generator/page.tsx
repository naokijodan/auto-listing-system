...
type TabKey = "dashboard" | "listings" | "keywords" | "suggestions" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-keyword-generator";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  listings: `${BASE}/listings/list`,
  keywords: `${BASE}/keywords/list`,
  suggestions: `${BASE}/suggestions/list`,
  analytics: `${BASE}/analytics`,
  settings: `${BASE}/settings`,
};

export default function ListingKeywordGeneratorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-red-600">出品キーワードジェネレーター</h1>
        <p className="text-sm text-gray-500">Listing Keyword Generator</p>
      </header>
