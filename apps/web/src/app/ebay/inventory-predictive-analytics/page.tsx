...
type TabKey = "dashboard" | "predictions" | "models" | "forecasts" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-predictive-analytics/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-lime-600">在庫予測アナリティクス</h1>
        <p className="text-sm text-gray-500">Inventory Predictive Analytics</p>
      </header>
