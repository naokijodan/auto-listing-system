...
const BASE_API = '/api/ebay-dynamic-pricing-engine/';

export default function DynamicPricingEnginePage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-violet-600">ダイナミックプライシング</h1>
