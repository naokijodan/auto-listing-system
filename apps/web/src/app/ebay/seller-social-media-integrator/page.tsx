...
const API_BASE = '/api/ebay-seller-social-media-integrator/';
...
export default function SellerSocialMediaIntegratorPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-fuchsia-600">セラーSNS連携ツール</h1>
