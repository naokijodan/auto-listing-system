...
const TABS: Tab[] = [
  ...
  { key: 'parameters', label: 'パラメータ', endpoint: 'parameters/list' },
...
const API_BASE = '/api/ebay-inventory-safety-stock-calculator/';

export function InventorySafetyStockCalculatorPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-teal-600">在庫安全在庫計算機</h1>
...
export default function Page() {
  return <InventorySafetyStockCalculatorPage />;
}
