...
type TabKey = "dashboard" | "tags" | "products" | "groups" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-tag-manager";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  tags: `${BASE}/tags/list`,
  products: `${BASE}/products/list`,
  groups: `${BASE}/groups/list`,
...
export default function ProductTagManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-blue-600">商品タグ管理</h1>
        <p className="text-sm text-gray-500">Product Tag Manager</p>
      </header>
