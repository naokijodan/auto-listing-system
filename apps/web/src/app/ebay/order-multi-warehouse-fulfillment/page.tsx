...
type TabKey = "dashboard" | "warehouses" | "fulfillments" | "routing" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-multi-warehouse-fulfillment/";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}dashboard`,
  warehouses: `${BASE}warehouses`,
  fulfillments: `${BASE}fulfillments`,
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-cyan-600">注文マルチ倉庫フルフィルメント</h1>
        <p className="text-sm text-gray-500">Order Multi Warehouse Fulfillment</p>
      </header>
