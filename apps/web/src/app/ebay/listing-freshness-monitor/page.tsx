...
type TabKey = "dashboard" | "listings" | "rules" | "schedules" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-freshness-monitor";
...
export default function ListingFreshnessMonitorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-purple-600">出品鮮度モニター</h1>
        <p className="text-sm text-gray-500">Listing Freshness Monitor</p>
      </header>
