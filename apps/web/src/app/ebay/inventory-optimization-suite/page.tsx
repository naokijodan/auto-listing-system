...
const TABS: { key: string; label: string }[] = [
  ...
  { key: 'recommendations', label: '推奨' },
  { key: 'reports', label: 'レポート' },
  { key: 'analytics', label: '分析' },
  { key: 'settings', label: '設定' },
];

const API_BASE = '/api/ebay-inventory-optimization-suite/';
...
export default function InventoryOptimizationSuitePage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-blue-600">在庫最適化スイート</h1>
