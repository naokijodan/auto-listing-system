...
const API_BASE = '/api/ebay-listing-multi-format/';

const TABS = [
  { key: 'dashboard', label: 'ダッシュボード', endpoint: 'dashboard/summary' },
  { key: 'listings', label: '出品', endpoint: 'listings' },
  { key: 'formats', label: 'フォーマット', endpoint: 'formats' },
  { key: 'conversions', label: '変換', endpoint: 'conversions' },
...
export default function Page(): React.ReactElement {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold text-lime-600">出品マルチフォーマット</h1>
