...
const TABS = [
  ...
  { key: "kits", label: "キット", path: "kits/summary" },
  { key: "components", label: "部品", path: "components/summary" },
  { key: "assembly", label: "組立", path: "assembly/summary" },
  { key: "analytics", label: "分析", path: "analytics/overview" },
  { key: "settings", label: "設定", path: "settings/get" },
] as const;

const API_BASE = "/api/ebay-inventory-kitting-manager/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-purple-600">在庫キッティング管理</h1>
