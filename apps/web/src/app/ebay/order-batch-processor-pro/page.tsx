...
const API_BASE = '/api/ebay-order-batch-processor-pro/';
...
export default function OrderBatchProcessorProPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-slate-600">注文バッチプロセッサーPro</h1>
