...
type TabKey = "dashboard" | "quality" | "gates" | "inventory" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-quality-gate/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-purple-600">在庫クオリティゲート</h1>
        <p className="text-sm text-gray-500">Inventory Quality Gate</p>
      </header>
