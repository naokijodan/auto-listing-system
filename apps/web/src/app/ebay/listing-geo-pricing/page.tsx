...
type TabKey = "dashboard" | "listings" | "regions" | "prices" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-geo-pricing/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-pink-600">出品ジオプライシング</h1>
        <p className="text-sm text-gray-500">Listing Geo Pricing</p>
      </header>
