...
const API_BASE = '/api/ebay-seller-compliance-center';

export default function SellerComplianceCenterPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-rose-600">セラーコンプライアンスセンター</h1>
