...
const TABS = [
  ...
  {"key":"products","label":"商品","path":"resources"},
  {"key":"operations","label":"オペレーション","path":"variants"},
  {"key":"quality","label":"クオリティ","path":"listings"},
  {"key":"analytics","label":"分析","path":"analytics/overview"},
  {"key":"settings","label":"設定","path":"settings"}
] as const;

const API_BASE = "/api/ebay-product-tetrahedrite-associated-analysis-pyrargyrite-basin/";
