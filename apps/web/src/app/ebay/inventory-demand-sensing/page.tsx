...
type TabKey = "dashboard" | "inventory" | "demands" | "signals" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-demand-sensing/";
...
export default function InventoryDemandSensingPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-emerald-600">在庫デマンドセンシング</h1>
        <p className="text-sm text-gray-500">Inventory Demand Sensing</p>
      </header>
