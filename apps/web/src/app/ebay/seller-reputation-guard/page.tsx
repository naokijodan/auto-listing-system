...
type TabKey = "dashboard" | "reputation" | "reviews" | "alerts" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-reputation-guard";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  reputation: `${BASE}/reputation/list`,
...
export default function SellerReputationGuardPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-emerald-600">セラー評判ガード</h1>
        <p className="text-sm text-gray-500">Seller Reputation Guard</p>
      </header>
