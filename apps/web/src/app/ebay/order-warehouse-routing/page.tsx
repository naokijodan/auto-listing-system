...
type TabKey = "dashboard" | "warehouses" | "routes" | "orders" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-warehouse-routing/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-yellow-600">注文ウェアハウスルーティング</h1>
        <p className="text-sm text-gray-500">Order Warehouse Routing</p>
      </header>
