...
type TabKey = 'dashboard' | 'inventory' | 'costs' | 'optimization' | 'analytics' | 'settings'
...
const API_BASE = '/api/ebay-inventory-cost-optimizer/'
...
export default function InventoryCostOptimizerPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-lime-600">在庫コスト最適化</h1>
        ...
        {TABS.map((t) => (
          <button
            ...
            className={`px-3 py-1 rounded-t ${
              active === t.key ? 'bg-lime-50 text-lime-700 border border-b-0 border-lime-200' : 'text-gray-600 hover:text-lime-700'
            }`}
          >
            {t.label}
          </button>
