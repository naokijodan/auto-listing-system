...
const API_BASE = '/api/ebay-product-cross-border-tool/';
...
const TABS: { label: string; section: string; action: string }[] = [
  ...
  { label: '市場', section: 'markets', action: 'list' },
...
export default function Page() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold text-indigo-600">商品クロスボーダーツール</h1>
