...
type TabKey = "dashboard" | "products" | "metrics" | "alerts" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-health-monitor";
...
export default function InventoryHealthMonitorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-cyan-600">在庫ヘルスモニター</h1>
        <p className="text-sm text-gray-500">Inventory Health Monitor</p>
      </header>
