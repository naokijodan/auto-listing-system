...
type TabKey = "dashboard" | "gift-orders" | "options" | "messages" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-gift-wrapper";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  "gift-orders": `${BASE}/gift-orders`,
...
export default function OrderGiftWrapperPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-orange-600">注文ギフトラッパー</h1>
        <p className="text-sm text-gray-500">Order Gift Wrapper</p>
      </header>
