...
type TabKey = "dashboard" | "counts" | "schedules" | "discrepancies" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-count-scheduler";
...
export default function InventoryCountSchedulerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-pink-600">棚卸スケジューラー</h1>
        <p className="text-sm text-gray-500">Inventory Count Scheduler</p>
      </header>
