...
type TabKey = "dashboard" | "audiences" | "insights" | "listings" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-audience-insights/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-blue-600">出品オーディエンスインサイト</h1>
        <p className="text-sm text-gray-500">Listing Audience Insights</p>
      </header>
