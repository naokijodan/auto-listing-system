...
type TabKey = "dashboard" | "orders" | "queues" | "rules" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-priority-queue";
...
export default function OrderPriorityQueuePage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-green-600">注文優先キュー</h1>
        <p className="text-sm text-gray-500">Order Priority Queue</p>
      </header>
