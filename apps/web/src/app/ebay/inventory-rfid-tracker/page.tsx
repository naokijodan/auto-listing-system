...
type TabKey = "dashboard" | "inventory" | "rfid" | "scans" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-rfid-tracker/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-amber-600">在庫RFIDトラッカー</h1>
        <p className="text-sm text-gray-500">Inventory RFID Tracker</p>
      </header>
