...
type TabKey = "dashboard" | "commissions" | "payments" | "rates" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-commission-tracker/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-emerald-600">セラーコミッショントラッカー</h1>
        <p className="text-sm text-gray-500">Seller Commission Tracker</p>
      </header>
