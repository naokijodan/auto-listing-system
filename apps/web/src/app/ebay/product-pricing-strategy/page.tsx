...
type TabKey = 'dashboard' | 'products' | 'strategies' | 'competitors' | 'analytics' | 'settings';
...
const API_BASE = '/api/ebay-product-pricing-strategy';
...
function endpointForTab(tab: TabKey): string {
  switch (tab) {
    ...
    case 'strategies':
      return `${API_BASE}/strategies`;
    case 'competitors':
      return `${API_BASE}/competitors`;
    case 'analytics':
...
export default function ProductPricingStrategyPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-red-600">商品価格戦略</h1>
