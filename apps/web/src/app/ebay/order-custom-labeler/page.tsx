...
const TABS = [
  ...
  { key: 'labels', label: 'ラベル', path: 'labels' },
  { key: 'templates', label: 'テンプレート', path: 'templates' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-order-custom-labeler/'

export default function OrderCustomLabelerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-blue-600">注文カスタムラベラー</h1>
