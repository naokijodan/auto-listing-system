...
type TabKey = "dashboard" | "photos" | "presets" | "templates" | "analytics" | "settings";
...
const BASE = "/api/ebay-bulk-photo-editor";
...
export default function BulkPhotoEditorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-blue-600">一括写真エディター</h1>
        <p className="text-sm text-gray-500">Bulk Photo Editor</p>
      </header>
