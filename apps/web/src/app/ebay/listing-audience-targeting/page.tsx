...
type TabKey = 'dashboard' | 'listings' | 'audiences' | 'segments' | 'analytics' | 'settings';

const TABS: { key: TabKey; label: string }[] = [
  { key: 'dashboard', label: 'ダッシュボード' },
  { key: 'listings', label: '出品' },
  { key: 'audiences', label: 'オーディエンス' },
  { key: 'segments', label: 'セグメント' },
  { key: 'analytics', label: '分析' },
  { key: 'settings', label: '設定' },
];

const API_BASE = '/api/ebay-listing-audience-targeting/';
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-semibold text-rose-600">出品オーディエンスターゲティング</h1>
