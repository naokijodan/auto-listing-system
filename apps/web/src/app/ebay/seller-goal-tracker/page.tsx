...
type TabKey = "dashboard" | "goals" | "milestones" | "progress" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-goal-tracker";
...
export default function SellerGoalTrackerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-lime-600">セラー目標トラッカー</h1>
        <p className="text-sm text-gray-500">Seller Goal Tracker</p>
      </header>
