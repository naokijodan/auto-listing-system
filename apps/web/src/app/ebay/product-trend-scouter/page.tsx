...
const TABS = [
  ...
  { key: "trends", label: "トレンド", path: "trends/overview" },
  { key: "scouting", label: "スカウティング", path: "scouting/overview" },
  { key: "analytics", label: "分析", path: "analytics/overview" },
  { key: "settings", label: "設定", path: "settings/get" },
] as const;

const API_BASE = "/api/ebay-product-trend-scouter/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-rose-600">商品トレンドスカウター</h1>
