...
const API_BASE = '/api/ebay-order-refund-processor/';

const tabs = [
  { key: 'dashboard', label: 'ダッシュボード' },
  { key: 'refunds', label: '返金' },
  { key: 'policies', label: 'ポリシー' },
  { key: 'appeals', label: '異議' },
...
export default function OrderRefundProcessorPage(): React.ReactElement {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-emerald-600">注文返金処理ツール</h1>
          ...
          <button
            ...
            className={
              ...
              (active === t.key
                ...
                : 'border-transparent text-gray-600 hover:text-emerald-600 hover:border-emerald-600')
            }
