...
const TABS = [
  ...
  { key: "orders", label: "注文", path: "orders/list" },
  { key: "routing", label: "ルーティング", path: "routing/simulate" },
  { key: "rules", label: "ルール", path: "rules/list" },
  { key: "analytics", label: "分析", path: "analytics/overview" },
  { key: "settings", label: "設定", path: "settings/get" },
] as const;

const API_BASE = "/api/ebay-order-intelligent-routing/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-sky-600">注文インテリジェントルーティング</h1>
