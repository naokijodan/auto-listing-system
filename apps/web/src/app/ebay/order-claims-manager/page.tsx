...
const TABS = [
  ...
  { key: 'claims', label: 'クレーム', path: 'claims' },
  { key: 'templates', label: 'テンプレート', path: 'templates' },
  { key: 'evidence', label: '証拠', path: 'evidence' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-order-claims-manager/'

export default function OrderClaimsManagerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-red-600">注文クレーム管理</h1>
