...
type TabKey = "dashboard" | "routes" | "warehouses" | "rules" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-routing-engine";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  routes: `${BASE}/routes/list`,
  warehouses: `${BASE}/warehouses/list`,
  rules: `${BASE}/rules/list`,
  analytics: `${BASE}/analytics`,
  settings: `${BASE}/settings`,
};

export default function OrderRoutingEnginePage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-amber-600">注文ルーティングエンジン</h1>
        <p className="text-sm text-gray-500">Order Routing Engine</p>
      </header>
