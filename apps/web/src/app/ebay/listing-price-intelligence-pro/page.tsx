...
type TabKey = "dashboard" | "listings" | "prices" | "intelligence" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-price-intelligence-pro/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-violet-600">出品プライスインテリジェンスPro</h1>
        <p className="text-sm text-gray-500">Listing Price Intelligence Pro</p>
      </header>
