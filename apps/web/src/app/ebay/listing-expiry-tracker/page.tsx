...
type TabKey = "dashboard" | "listings" | "schedules" | "alerts" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-expiry-tracker";
...
export default function ListingExpiryTrackerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-yellow-600">出品期限トラッカー</h1>
        <p className="text-sm text-gray-500">期限切れ前のリスクを検知し自動更新</p>
      </header>
