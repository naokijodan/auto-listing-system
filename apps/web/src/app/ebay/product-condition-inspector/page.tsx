...
type TabKey = "dashboard" | "products" | "inspections" | "grades" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-condition-inspector/";
...
export default function ProductConditionInspectorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-amber-600">商品コンディションインスペクター</h1>
        <p className="text-sm text-gray-500">Product Condition Inspector</p>
      </header>
