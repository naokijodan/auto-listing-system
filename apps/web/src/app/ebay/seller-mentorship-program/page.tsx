...
type TabKey = "dashboard" | "mentors" | "programs" | "sellers" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-mentorship-program/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-cyan-600">セラーメンターシッププログラム</h1>
        <p className="text-sm text-gray-500">Seller Mentorship Program</p>
      </header>
