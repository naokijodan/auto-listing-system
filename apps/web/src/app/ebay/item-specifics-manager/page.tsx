...
const BASE_API = '/api/ebay-item-specifics-manager/';

export default function ItemSpecificsManagerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-emerald-600">アイテムスペシフィクス管理</h1>
