...
type TabKey = "dashboard" | "watermarks" | "templates" | "images" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-watermark-tool";
...
export default function ListingWatermarkToolPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-emerald-600">出品透かしツール</h1>
        <p className="text-sm text-gray-500">出品画像に透かしを適用・管理</p>
      </header>
