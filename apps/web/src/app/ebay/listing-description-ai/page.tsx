...
const TABS = [
  ...
  { key: 'descriptions', label: '説明文', path: 'descriptions/list' },
  { key: 'templates', label: 'テンプレート', path: 'templates/list' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-listing-description-ai/'

export default function ListingDescriptionAiPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-rose-600">出品説明文AI生成</h1>
