...
type TabKey = "dashboard" | "orders" | "suppliers" | "tracking" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-dropship-coordinator/";
...
export default function OrderDropshipCoordinatorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-slate-600">注文ドロップシップコーディネーター</h1>
        <p className="text-sm text-gray-500">Order Dropship Coordinator</p>
      </header>
