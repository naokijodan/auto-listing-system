...
const TABS = [
  ...
  { key: "allocation", label: "配分", path: "allocation/overview" },
  { key: "strategies", label: "戦略", path: "strategies/list" },
  { key: "analytics", label: "分析", path: "analytics/overview" },
  { key: "settings", label: "設定", path: "settings/get" },
] as const;

const API_BASE = "/api/ebay-inventory-smart-allocation/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-amber-600">在庫スマートアロケーション</h1>
