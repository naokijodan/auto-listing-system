...
const TABS = [
  ...
  { key: "listings", label: "出品", path: "listings/summary" },
  { key: "timers", label: "タイマー", path: "timers/summary" },
...
const API_BASE = "/api/ebay-listing-countdown-timer/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-blue-600">出品カウントダウンタイマー</h1>
