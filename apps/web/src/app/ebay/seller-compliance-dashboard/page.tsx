...
type TabKey = "dashboard" | "policies" | "issues" | "audits" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-compliance-dashboard";
...
export default function SellerComplianceDashboardPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-teal-600">セラーコンプライアンスダッシュボード</h1>
        <p className="text-sm text-gray-500">ポリシー準拠状況の可視化と管理</p>
      </header>
