...
type TabKey = "dashboard" | "sellers" | "reports" | "visualizations" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-analytics-studio/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-violet-600">セラーアナリティクススタジオ</h1>
        <p className="text-sm text-gray-500">Seller Analytics Studio</p>
      </header>
