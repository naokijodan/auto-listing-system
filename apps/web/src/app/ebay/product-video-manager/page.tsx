...
type TabKey = "dashboard" | "videos" | "uploads" | "playlists" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-video-manager/";
...
export default function ProductVideoManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-green-600">商品動画管理</h1>
        <p className="text-sm text-gray-500">Product Video Manager</p>
      </header>
