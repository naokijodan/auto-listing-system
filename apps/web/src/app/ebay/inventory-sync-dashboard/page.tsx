...
const API_BASE = '/api/ebay-inventory-sync-dashboard/';
...
export default function InventorySyncDashboardPage(): React.ReactElement {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-sky-600">在庫同期ダッシュボード</h1>
          ...
          <button
            ...
            className={
              ...
              (active === t.key
                ...
                : 'border-transparent text-gray-600 hover:text-sky-600 hover:border-sky-600')
            }
