...
const API_BASE = '/api/ebay-listing-smart-template-pro/';
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-orange-600">出品スマートテンプレートPro</h1>
        ...
        {TABS.map((t) => (
          <button
            ...
            className={`pb-2 -mb-px border-b-2 text-sm ${
              activeTab === t.key ? 'border-orange-600 text-orange-600' : 'border-transparent text-gray-600'
            }`}
          >
            {t.label}
          </button>
