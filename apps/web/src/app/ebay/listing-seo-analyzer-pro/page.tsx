...
const TABS: Tab[] = [
  ...
  { key: 'keywords', label: 'キーワード', endpoint: 'keywords/list' },
...
const API_BASE = '/api/ebay-listing-seo-analyzer-pro/';

export function ListingSeoAnalyzerProPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-violet-600">出品SEO分析Pro</h1>
...
export default function Page() {
  return <ListingSeoAnalyzerProPage />;
}
