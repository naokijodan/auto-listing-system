...
type TabKey = "dashboard" | "specs" | "sheets" | "products" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-spec-sheet-generator/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-slate-600">商品スペックシートジェネレーター</h1>
        <p className="text-sm text-gray-500">Product Spec Sheet Generator</p>
      </header>
