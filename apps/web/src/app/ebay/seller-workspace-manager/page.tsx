...
const TABS = [
  ...
  { key: 'workspaces', label: 'ワークスペース', path: 'workspaces' },
  { key: 'teams', label: 'チーム', path: 'teams' },
  { key: 'permissions', label: '権限', path: 'permissions' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-seller-workspace-manager/'

export default function SellerWorkspaceManagerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-purple-600">セラーワークスペース管理</h1>
