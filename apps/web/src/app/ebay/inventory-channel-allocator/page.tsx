...
const apiBase = '/api/ebay-inventory-channel-allocator/';

export default function InventoryChannelAllocatorPage(): React.ReactElement {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-red-600">在庫チャネル配分マネージャー</h1>
