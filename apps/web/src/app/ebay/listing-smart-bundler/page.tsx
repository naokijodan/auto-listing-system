...
type TabKey = "dashboard" | "listings" | "bundles" | "recommendations" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-smart-bundler/";
...
export default function ListingSmartBundlerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-cyan-600">出品スマートバンドラー</h1>
        <p className="text-sm text-gray-500">Listing Smart Bundler</p>
      </header>
