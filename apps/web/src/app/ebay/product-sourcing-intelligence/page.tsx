...
const API_BASE = '/api/ebay-product-sourcing-intelligence/';
...
export default function ProductSourcingIntelligencePage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-purple-600">商品ソーシングインテリジェンス</h1>
