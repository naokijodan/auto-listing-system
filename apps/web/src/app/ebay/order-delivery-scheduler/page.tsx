...
type TabKey = 'dashboard' | 'orders' | 'schedules' | 'routes' | 'analytics' | 'settings';
...
const API_BASE = '/api/ebay-order-delivery-scheduler/';
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-semibold text-teal-600">注文配送スケジューラー</h1>
