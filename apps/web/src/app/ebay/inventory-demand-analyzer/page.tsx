...
const API_BASE = '/api/ebay-inventory-demand-analyzer';
...
export default function InventoryDemandAnalyzerPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-yellow-600">在庫需要分析ツール</h1>
        ...
        {TABS.map((t) => (
          <button
            ...
            className={`px-3 py-2 text-sm rounded-t-md border-b-2 ${
              tab === t.key ? 'border-yellow-600 text-yellow-600' : 'border-transparent text-gray-600 hover:text-gray-800'
            }`}
          >
            {t.label}
          </button>
