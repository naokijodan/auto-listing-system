...
const API_BASE = '/api/ebay-seller-ai-advisor/';

const TABS: { label: string; section: string; action: string }[] = [
  { label: 'ダッシュボード', section: 'dashboard', action: 'summary' },
  { label: 'アドバイス', section: 'advice', action: 'list' },
  { label: '戦略', section: 'strategies', action: 'list' },
  { label: '予測', section: 'predictions', action: 'list' },
...
export default function Page() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold text-teal-600">セラーAIアドバイザー</h1>
