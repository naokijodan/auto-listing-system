...
type TabKey = "dashboard" | "reports" | "templates" | "schedules" | "analytics" | "settings";
...
const BASE = "/api/ebay-custom-report-builder";
...
export default function CustomReportBuilderPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-violet-600">カスタムレポートビルダー</h1>
        <p className="text-sm text-gray-500">柔軟なレポートの作成と配信</p>
      </header>
