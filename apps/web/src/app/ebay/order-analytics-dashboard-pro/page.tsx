...
const API_BASE = '/api/ebay-order-analytics-dashboard-pro';

export default function OrderAnalyticsDashboardProPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-amber-600">注文分析ダッシュボードPro</h1>
