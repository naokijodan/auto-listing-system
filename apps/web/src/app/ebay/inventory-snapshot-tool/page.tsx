...
type TabKey = "dashboard" | "snapshots" | "changes" | "reports" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-snapshot-tool";
...
export default function InventorySnapshotToolPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-green-600">在庫スナップショットツール</h1>
        <p className="text-sm text-gray-500">在庫のスナップショット作成と差分追跡</p>
      </header>
