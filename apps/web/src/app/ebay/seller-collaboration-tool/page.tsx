...
const API_BASE = '/api/ebay-seller-collaboration-tool/';

const TABS = [
  { key: 'dashboard', label: 'ダッシュボード', endpoint: 'dashboard/summary' },
  { key: 'collab', label: 'コラボ', endpoint: 'collaborations' },
  { key: 'teams', label: 'チーム', endpoint: 'teams' },
  { key: 'messages', label: 'メッセージ', endpoint: 'messages' },
...
export default function Page(): JSX.Element {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold text-amber-600">セラーコラボレーションツール</h1>
