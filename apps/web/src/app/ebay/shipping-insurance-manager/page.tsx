...
type TabKey = "dashboard" | "policies" | "claims" | "providers" | "analytics" | "settings";
...
const BASE = "/api/ebay-shipping-insurance-manager";
...
export default function ShippingInsuranceManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-blue-600">配送保険管理</h1>
        <p className="text-sm text-gray-500">配送保険の契約・申請・分析</p>
      </header>
