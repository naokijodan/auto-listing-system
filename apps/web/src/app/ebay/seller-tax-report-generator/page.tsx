...
type TabKey = "dashboard" | "reports" | "periods" | "deductions" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-tax-report-generator";
...
export default function SellerTaxReportGeneratorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-rose-600">セラー税務レポート生成</h1>
        <p className="text-sm text-gray-500">Seller Tax Report Generator</p>
      </header>
