...
const TABS = [
  ...
  { key: 'packages', label: 'パッケージ', path: 'packages' },
  { key: 'shipping', label: '配送', path: 'shipping' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-product-weight-calculator/'

export default function ProductWeightCalculatorPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-purple-600">商品重量計算機</h1>
