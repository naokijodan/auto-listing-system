...
const API_BASE = '/api/ebay-product-competitor-price-watch/'

export default function ProductCompetitorPriceWatchPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-violet-600">商品競合価格ウォッチ</h1>
