...
type TabKey = "dashboard" | "products" | "searches" | "results" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-visual-search/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-orange-600">商品ビジュアルサーチ</h1>
        <p className="text-sm text-gray-500">Product Visual Search</p>
      </header>
