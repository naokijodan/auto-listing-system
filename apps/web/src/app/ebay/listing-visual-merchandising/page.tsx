...
const API_BASE = '/api/ebay-listing-visual-merchandising/';

const TABS: { label: string; section: string; action: string }[] = [
  { label: 'ダッシュボード', section: 'dashboard', action: 'summary' },
  { label: '出品', section: 'listings', action: 'list' },
  { label: 'ディスプレイ', section: 'displays', action: 'list' },
  { label: 'ギャラリー', section: 'galleries', action: 'list' },
...
export default function Page() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold text-amber-600">出品ビジュアルマーチャンダイジング</h1>
