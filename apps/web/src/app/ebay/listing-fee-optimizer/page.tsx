...
const TABS = [
  ...
  { key: 'feetypes', label: '手数料種別', path: 'fee-types' },
  { key: 'recommendations', label: '推奨', path: 'recommendations' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-listing-fee-optimizer/'

export default function ListingFeeOptimizerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-slate-600">出品手数料最適化</h1>
