...
type TabKey = "dashboard" | "bots" | "strategies" | "history" | "analytics" | "settings";
...
const BASE = "/api/ebay-automated-repricing-bot";
...
export default function AutomatedRepricingBotPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-fuchsia-600">自動価格調整ボット</h1>
        <p className="text-sm text-gray-500">Automated Repricing Bot</p>
      </header>
