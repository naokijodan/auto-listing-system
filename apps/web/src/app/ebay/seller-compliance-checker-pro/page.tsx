...
const TABS = [
  ...
  { key: 'checks', label: 'チェック', path: 'checks' },
  { key: 'policies', label: 'ポリシー', path: 'policies' },
  { key: 'violations', label: '違反', path: 'violations' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-seller-compliance-checker-pro/'

export default function SellerComplianceCheckerProPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-yellow-600">セラーコンプライアンスチェッカーPro</h1>
