...
type TabKey = "dashboard" | "products" | "charts" | "templates" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-size-chart-manager";
...
export default function ProductSizeChartManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-purple-600">商品サイズチャート管理</h1>
        <p className="text-sm text-gray-500">Product Size Chart Manager</p>
      </header>
