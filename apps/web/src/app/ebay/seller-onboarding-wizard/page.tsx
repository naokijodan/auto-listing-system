...
type TabKey = "dashboard" | "steps" | "checklists" | "resources" | "analytics" | "settings";
...
const BASE = "/api/ebay-seller-onboarding-wizard";
...
export default function SellerOnboardingWizardPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-slate-600">セラーオンボーディングウィザード</h1>
        <p className="text-sm text-gray-500">Seller Onboarding Wizard</p>
      </header>
