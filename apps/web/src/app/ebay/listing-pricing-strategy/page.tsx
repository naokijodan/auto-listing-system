...
const BASE_API = '/api/ebay-listing-pricing-strategy/';

export default function ListingPricingStrategyPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-slate-600">出品価格戦略エンジン</h1>
