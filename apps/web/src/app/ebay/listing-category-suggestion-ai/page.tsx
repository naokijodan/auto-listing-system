...
type TabKey = "dashboard" | "categories" | "suggestions" | "ai" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-category-suggestion-ai/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-purple-600">出品カテゴリサジェストAI</h1>
        <p className="text-sm text-gray-500">Listing Category Suggestion AI</p>
      </header>
