...
type TabKey = "dashboard" | "returns" | "reasons" | "policies" | "analytics" | "settings";
...
const BASE = "/api/ebay-returns-dashboard-pro";
...
export default function ReturnsDashboardProPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-fuchsia-600">返品ダッシュボードPro</h1>
        <p className="text-sm text-gray-500">返品の可視化と迅速な対応</p>
      </header>
