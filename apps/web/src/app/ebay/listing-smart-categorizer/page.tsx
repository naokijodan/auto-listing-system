...
export default function ListingSmartCategorizerPage() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-teal-600">出品スマートカテゴライザー</h1>
