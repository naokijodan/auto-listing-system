...
type TabKey = "dashboard" | "inventory" | "waste" | "optimization" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-waste-reducer/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-red-600">在庫ウェイストリデューサー</h1>
        <p className="text-sm text-gray-500">Inventory Waste Reducer</p>
      </header>
