...
type TabKey = "dashboard" | "discounts" | "rules" | "campaigns" | "analytics" | "settings";
...
const BASE = "/api/ebay-dynamic-discount-manager";
...
export default function DynamicDiscountManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-yellow-600">ダイナミック割引管理</h1>
        <p className="text-sm text-gray-500">Dynamic Discount Manager</p>
      </header>
