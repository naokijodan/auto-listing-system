...
type TabKey = "dashboard" | "keywords" | "rankings" | "competitors" | "analytics" | "settings";
...
const BASE = "/api/ebay-keyword-rank-tracker";
...
export default function KeywordRankTrackerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-amber-600">キーワードランクトラッカー</h1>
        <p className="text-sm text-gray-500">キーワード順位の追跡と可視化</p>
      </header>
