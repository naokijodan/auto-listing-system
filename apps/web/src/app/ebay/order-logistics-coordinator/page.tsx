...
type Tab = 'dashboard' | 'shipments' | 'carriers' | 'routes' | 'analytics' | 'settings';

const API_BASE = '/api/ebay-order-logistics-coordinator/';
...
export default function OrderLogisticsCoordinatorPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-lime-600">注文ロジスティクスコーディネーター</h1>
        <p className="text-sm text-gray-500 mt-1">eBay Order Logistics Coordinator</p>
      </div>
        ...
        {TABS.map((t) => (
          <button
            ...
            className={`px-3 py-2 text-sm border-b-2 -mb-px transition-colors ${
              active === t.key ? 'border-lime-600 text-lime-600' : 'border-transparent text-gray-600 hover:text-lime-600'
            }`}
