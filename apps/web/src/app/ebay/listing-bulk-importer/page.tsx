...
const API_BASE = '/api/ebay-listing-bulk-importer/'

export default function ListingBulkImporterPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-green-600">出品一括インポーター</h1>
