...
const TABS = [
  ...
  { key: 'channels', label: 'チャネル', path: 'channels/list' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-order-notification-center/'

export default function OrderNotificationCenterPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-teal-600">注文通知センター</h1>
