...
const API_BASE = "/api/ebay-buyer-loyalty-program/";

const tabs = [
  { key: "dashboard", label: "ダッシュボード", path: "dashboard" },
  { key: "members", label: "メンバー", path: "members" },
  { key: "rewards", label: "特典", path: "rewards" },
  { key: "tiers", label: "ティア", path: "tiers" },
  { key: "analytics", label: "分析", path: "analytics" },
  { key: "settings", label: "設定", path: "settings" },
];

export default function BuyerLoyaltyProgramPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-amber-600">バイヤーロイヤルティプログラム</h1>
        ...
        {tabs.map((t) => (
          <button
            ...
            className={`px-3 py-2 text-sm border-b-2 -mb-px ${
              active === t.key ? "border-amber-600 text-amber-600" : "border-transparent text-gray-600 hover:text-gray-900"
            }`}
          >
            {t.label}
          </button>
