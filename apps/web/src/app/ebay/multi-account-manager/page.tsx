...
type TabKey = "dashboard" | "accounts" | "sync" | "permissions" | "analytics" | "settings";
...
const BASE = "/api/ebay-multi-account-manager";
...
export default function MultiAccountManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-indigo-600">マルチアカウント管理</h1>
        <p className="text-sm text-gray-500">Multi-Account Manager</p>
      </header>
