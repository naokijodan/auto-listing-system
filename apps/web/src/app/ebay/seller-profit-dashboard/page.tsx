...
type TabKey = 'dashboard' | 'products' | 'expenses' | 'reports' | 'analytics' | 'settings'
...
const API_BASE = '/api/ebay-seller-profit-dashboard'
...
export default function SellerProfitDashboardPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-semibold text-orange-600">セラー利益ダッシュボード</h1>
