...
type TabKey = 'dashboard' | 'orders' | 'addresses' | 'validations' | 'analytics' | 'settings';
...
const API_BASE = '/api/ebay-order-address-validator/';
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-semibold text-amber-600">注文住所バリデーター</h1>
      ...
      <div className="text-sm text-gray-700">
        ...
        {error && <div className="text-amber-600">エラー: {error}</div>}
        {!loading && !error && (
