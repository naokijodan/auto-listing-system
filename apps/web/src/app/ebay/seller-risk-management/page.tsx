...
const tabs = [
  ...
  { key: 'risks', label: 'リスク', endpoint: 'risks' },
  { key: 'policies', label: 'ポリシー', endpoint: 'policies' },
  { key: 'alerts', label: 'アラート', endpoint: 'alerts' },
  { key: 'analytics', label: '分析', endpoint: 'analytics' },
  { key: 'settings', label: '設定', endpoint: 'settings' },
] as const;

const apiBase = '/api/ebay-seller-risk-management/';

export default function SellerRiskManagementPage(): React.ReactElement {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-fuchsia-600">セラーリスク管理ダッシュボード</h1>
