...
const BASE_API = '/api/ebay-inventory-liquidation-manager/';

export default function InventoryLiquidationManagerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-orange-600">在庫リキデーション管理</h1>
