...
type TabKey = 'dashboard' | 'orders' | 'rules' | 'queues' | 'analytics' | 'settings'
...
const API_BASE = '/api/ebay-order-priority-router'
...
export default function OrderPriorityRouterPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-semibold text-teal-600">注文優先ルーター</h1>
