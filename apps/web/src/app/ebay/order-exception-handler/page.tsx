...
type TabKey = "dashboard" | "exceptions" | "rules" | "workflows" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-exception-handler";
...
export default function OrderExceptionHandlerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-purple-600">注文例外ハンドラー</h1>
        <p className="text-sm text-gray-500">Order Exception Handler</p>
      </header>
