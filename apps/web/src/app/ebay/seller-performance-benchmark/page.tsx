...
const TABS = [
  ...
  { key: "benchmarks", label: "ベンチマーク", path: "benchmarks/list" },
  { key: "comparisons", label: "比較", path: "comparisons/list" },
  { key: "analytics", label: "分析", path: "analytics/overview" },
  { key: "settings", label: "設定", path: "settings/get" },
] as const;

const API_BASE = "/api/ebay-seller-performance-benchmark/";
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold text-violet-600">セラーパフォーマンスベンチマーク</h1>
