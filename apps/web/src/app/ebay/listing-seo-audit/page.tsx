...
type TabKey = "dashboard" | "audits" | "issues" | "recommendations" | "analytics" | "settings";
...
const BASE = "/api/ebay-listing-seo-audit";
...
export default function ListingSeoAuditPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-rose-600">出品SEO監査</h1>
        <p className="text-sm text-gray-500">出品SEOのスコアや課題を診断</p>
      </header>
