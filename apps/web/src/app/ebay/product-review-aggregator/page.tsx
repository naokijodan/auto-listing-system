...
type TabKey = "dashboard" | "reviews" | "products" | "sentiment" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-review-aggregator";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  reviews: `${BASE}/reviews/list`,
  products: `${BASE}/products/list`,
  sentiment: `${BASE}/sentiment/list`,
  analytics: `${BASE}/analytics`,
  settings: `${BASE}/settings`,
};

export default function ProductReviewAggregatorPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-violet-600">商品レビュー集約</h1>
        <p className="text-sm text-gray-500">Product Review Aggregator</p>
      </header>
