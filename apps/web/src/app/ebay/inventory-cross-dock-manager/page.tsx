...
type TabKey = "dashboard" | "inventory" | "docks" | "transfers" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-cross-dock-manager/";
...
export default function InventoryCrossDockManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-red-600">在庫クロスドック管理</h1>
        <p className="text-sm text-gray-500">Inventory Cross-Dock Manager</p>
      </header>
