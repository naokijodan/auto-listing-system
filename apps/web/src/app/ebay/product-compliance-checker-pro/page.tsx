...
type TabKey = "dashboard" | "products" | "compliance" | "rules" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-compliance-checker-pro/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-yellow-600">商品コンプライアンスチェッカーPro</h1>
        <p className="text-sm text-gray-500">Product Compliance Checker Pro</p>
      </header>
