...
type TabKey = "dashboard" | "archives" | "categories" | "products" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-archive-manager/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-lime-600">商品アーカイブマネージャー</h1>
        <p className="text-sm text-gray-500">Product Archive Manager</p>
      </header>
