...
type TabKey = "dashboard" | "comparisons" | "sources" | "products" | "analytics" | "settings";
...
const BASE = "/api/ebay-price-comparison-engine";
...
export default function PriceComparisonEnginePage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-emerald-600">価格比較エンジン</h1>
        <p className="text-sm text-gray-500">Price Comparison Engine</p>
      </header>
