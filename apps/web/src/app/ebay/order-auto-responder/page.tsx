...
type TabKey = "dashboard" | "orders" | "responses" | "templates" | "analytics" | "settings";
...
const BASE = "/api/ebay-order-auto-responder/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-rose-600">注文オートレスポンダー</h1>
        <p className="text-sm text-gray-500">Order Auto Responder</p>
      </header>
