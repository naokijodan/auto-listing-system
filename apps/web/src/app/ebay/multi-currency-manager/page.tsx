...
const TABS = [
  ...
  { key: 'currencies', label: '通貨' },
  { key: 'conversions', label: '換算' },
  { key: 'rules', label: 'ルール' },
...
const BASE_API = '/api/ebay-multi-currency-manager/';

export default function MultiCurrencyManagerPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-pink-600">マルチ通貨管理</h1>
