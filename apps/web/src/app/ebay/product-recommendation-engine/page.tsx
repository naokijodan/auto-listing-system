...
type TabKey = "dashboard" | "products" | "recommendations" | "algorithms" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-recommendation-engine/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-green-600">商品レコメンデーションエンジン</h1>
        <p className="text-sm text-gray-500">Product Recommendation Engine</p>
      </header>
