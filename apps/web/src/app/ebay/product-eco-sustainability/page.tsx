...
const TABS = [
  ...
  { key: 'certifications', label: '認証', path: 'certifications' },
  { key: 'reports', label: 'レポート', path: 'reports' },
  { key: 'analytics', label: '分析', path: 'analytics' },
  { key: 'settings', label: '設定', path: 'settings' },
]

const API_BASE = '/api/ebay-product-eco-sustainability/'

export default function ProductEcoSustainabilityPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-cyan-600">商品エコサステナビリティ</h1>
