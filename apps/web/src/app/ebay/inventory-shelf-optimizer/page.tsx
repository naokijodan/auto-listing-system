...
type TabKey = "dashboard" | "inventory" | "shelves" | "placements" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-shelf-optimizer/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-teal-600">在庫シェルフオプティマイザー</h1>
        <p className="text-sm text-gray-500">Inventory Shelf Optimizer</p>
      </header>
