...
type TabKey = "dashboard" | "products" | "barcodes" | "formats" | "analytics" | "settings";
...
const BASE = "/api/ebay-product-barcode-generator/";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-rose-600">商品バーコードジェネレーター</h1>
        <p className="text-sm text-gray-500">Product Barcode Generator</p>
      </header>
