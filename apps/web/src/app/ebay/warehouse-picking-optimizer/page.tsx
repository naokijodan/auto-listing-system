...
type TabKey = "dashboard" | "picklists" | "zones" | "workers" | "analytics" | "settings";
...
const BASE = "/api/ebay-warehouse-picking-optimizer";
const ENDPOINTS: Record<TabKey, string> = {
  dashboard: `${BASE}/dashboard`,
  picklists: `${BASE}/picklists`,
  zones: `${BASE}/zones`,
...
export default function WarehousePickingOptimizerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-amber-600">倉庫ピッキング最適化</h1>
        <p className="text-sm text-gray-500">Warehouse Picking Optimizer</p>
      </header>
