...
type TabKey = "dashboard" | "inventory" | "expirations" | "alerts" | "analytics" | "settings";
...
const BASE = "/api/ebay-inventory-shelf-life-manager";
...
export default function InventoryShelfLifeManagerPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold text-blue-600">在庫シェルフライフ管理</h1>
        <p className="text-sm text-gray-500">Inventory Shelf Life Manager</p>
      </header>
