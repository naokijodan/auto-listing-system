...
// 商品クロスボーダーツール (テーマカラー: indigo-600)
const router = Router();
...
register('markets', 'analyze');
register('markets', 'enter');
register('markets', 'compare');

// regulations (4)
register('regulations', 'list');
register('regulations', 'check');
register('regulations', 'update');
register('regulations', 'export');
