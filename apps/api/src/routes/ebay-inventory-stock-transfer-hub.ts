...
// Locations (4)
router.get('/locations', (_req: Request, res: Response) => res.json({ section: 'locations', action: 'list' }));
router.get('/locations/:id', (_req: Request, res: Response) => res.json({ section: 'locations', action: 'detail' }));
router.post('/locations', (_req: Request, res: Response) => res.json({ section: 'locations', action: 'create' }));
router.put('/locations/:id', (_req: Request, res: Response) => res.json({ section: 'locations', action: 'update' }));
