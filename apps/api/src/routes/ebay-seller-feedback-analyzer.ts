...
router.post('/feedbacks/:id/analyze', (_req: Request, res: Response) =>
  res.json({ section: 'feedbacks', action: 'analyze' })
);
router.post('/feedbacks/:id/respond', (_req: Request, res: Response) =>
  res.json({ section: 'feedbacks', action: 'respond' })
);
router.post('/feedbacks/:id/flag', (_req: Request, res: Response) =>
  res.json({ section: 'feedbacks', action: 'flag' })
);
router.get('/feedbacks/:id/history', (_req: Request, res: Response) =>
...
router.post('/trends/analyze', (_req: Request, res: Response) =>
  res.json({ section: 'trends', action: 'analyze' })
);
...
router.get('/analytics/response-impact', (_req: Request, res: Response) =>
  res.json({ section: 'analytics', action: 'response-impact' })
);
