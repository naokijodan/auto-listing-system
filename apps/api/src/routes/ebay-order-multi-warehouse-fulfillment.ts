...
// Fulfillments (4)
router.get('/fulfillments', (_req: Request, res: Response) => res.json({ section: 'fulfillments', action: 'list' }));
router.get('/fulfillments/:id', (_req: Request, res: Response) => res.json({ section: 'fulfillments', action: 'detail' }));
router.post('/fulfillments', (_req: Request, res: Response) => res.json({ section: 'fulfillments', action: 'create' }));
router.put('/fulfillments/:id', (_req: Request, res: Response) => res.json({ section: 'fulfillments', action: 'update' }));

// Routing (4)
router.get('/routing', (_req: Request, res: Response) => res.json({ section: 'routing', action: 'list' }));
router.get('/routing/:id', (_req: Request, res: Response) => res.json({ section: 'routing', action: 'detail' }));
router.post('/routing', (_req: Request, res: Response) => res.json({ section: 'routing', action: 'create' }));
router.put('/routing/:id', (_req: Request, res: Response) => res.json({ section: 'routing', action: 'update' }));
