...
- ブランド名は必ず英語で返す（例: 任天堂→Nintendo, セイコー→Seiko, カシオ→Casio, バンダイ→Bandai）。ただし、元のタイトルに日本語と英語の両方でブランド名が含まれている場合（例: アブソラム ABSOLUM）、翻訳後のタイトルではブランド名を1回だけ含めること。重複させない。
- 日本語特有の表現は適切に意訳
- SEOを意識したキーワードを含める
...
【出力形式（JSON）】
{
  ...
  "attributes": {
    "brand": "Brand name in English (e.g. Nintendo, Seiko, Casio)",
    "color": "色",
    "size": "サイズ",
    "material": "素材",
    "condition": "new|like_new|good|fair",
